  ...
  return (
    <>
      ...
      <div className="about">
        ...
        <p>Our app allows you to personalize your experience by marking your favorite countries and leaving a diary entry, ensuring that you never forget those extraordinary places that captured your soul. Whether it's savoring delicious street food in Thailand or marveling at ancient ruins in Greece, your travel tales are meant to be celebrated and shared.</p>
